...
/** priority data type */
typedef u_int64_t pqueue_pri_t;
...
typedef u_int64_t (*pqueue_get_pos_f)(void *a);
typedef void (*pqueue_set_pos_f)(void *a, u_int64_t pos);
 ...
 * @param q the queue
 */
u_int64_t pqueue_size(pqueue_t *q);
